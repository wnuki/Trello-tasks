$(document).ready(function() {
    const apiRoot = 'https://young-citadel-48045.herokuapp.com/v1/trello';
    const trelloApiRoot = 'https://young-citadel-48045.herokuapp.com/v1/trello'
